...
SCRIPTS = ['data/floor01.js', 'data/floor02.js', 'data/face.js', 'data/town.js', 'data/balance.js', 'data/fxsheets.js', 'src/sprites.js', 'src/audio.js', 'src/icons.js', 'src/combat.js', 'src/game.js']

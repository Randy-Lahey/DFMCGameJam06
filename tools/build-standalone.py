...
SCRIPTS = ['data/floor01.js', 'data/floor02.js', 'data/face.js', 'data/town.js', 'data/vestibvlvm.js', 'data/cinerevm.js', 'data/pvtrefactorivm.js', 'data/thronvs.js', 'data/balance.js', 'data/fxsheets.js', 'src/sprites.js', 'src/audio.js', 'src/icons.js', 'src/combat.js', 'src/game.js']
